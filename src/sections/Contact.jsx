...
export default function Contact() {
  ...
  const validateForm = () => {
    ...
    if (!formData.idea.trim()) newErrors.idea = "Explain your idea";
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row items-center gap-10">
        ...
        >
          <motion.img
            src={Astra}
            alt="Contact"
            className="w-72 md:w-[520px] rounded-2xl shadow-lg object-cover"
            animate={{ y: [0, -10, 0] }}
...
//         const newErrors = {};
//         required.forEach((f) => !formData[f].trim())
...
//                 />
//                 {errors.name && (
//                   <p className="text-red-500 text-sx">{errors.name}</p>
//                 )}
//               </div>
//               <div className="flex flex-col">
//                 <label className="mb-1">
...
//                 />
//                 {errors.email && (
//                   <p className="text-red-500 text-sx">{errors.email}</p>
//                 )}
//               </div>
//               <div className="flex flex-col">
//                 <label className="mb-1">
