...
export default function About()
{
    const stats = [
      ...
      { label: "Speciality", value: "Data-Driven Full-Stack Development" },
    ...
    return (
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
          ...
          >
            <motion.div
              className="relative w-[160px] h-[160px] md:w-[200px] md:h-[200px]
                    rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-[#1cd8d2]/20 to-[#302b63]/20 border-[#1cd8d2]/25"
            >
            ...
            <div className="flex-1 flex flex-col justify-center text-center md:text-left">
              {/* <h2
                className="text-4xl sm:text-5xl font-extrabold tracking-tight bg-clip-text-transparent
             ...
             bg-gradient-to-r from-[#1cd8d2] via-[#00bf8f] to-[#1cd8d2]"
              ...
              <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
                ...
                performance, scalability, and user experience, while leveraging
                machine learning to create intelligent, data-driven solutions.
              </p>
          ...
          <motion.div
            className="text-cwenter md:text-left"
          ...
          >
            ...
            <p className="text-gray-300 leading relaxed text-base sm:text-lg">
              ...
              focusing on building scalable, data-driven, and high-performance
              applications. 
            </p>

            <p className="mt-4 text-gray-400 text-base sm:text-lg">
              My work emphasizes production-ready systems that deliver
              real-world impact through strong engineering and modern
              technologies.
            </p>
          </motion.div>
        </div>
