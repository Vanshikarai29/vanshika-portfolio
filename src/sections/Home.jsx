...
//     const roles=useMemo(()=>["Software Developer","Full Stack Developer","Backend Developer","Data Analyst","Data Scientist"],[])
...
//                             </span>
//                             <span className="inline-block w-[2px] m1-1 bg-white animate-pulse align-middle">
//                                 style={{height:"1em"}}
//                         </span>
//                         </motion.div>
//                     </div>
...
//     { Icon: FaLinkedin, label: "Linkedin", href:"https://www.linkedin.com/in/vanshika-rai-2b984a338/" },
//     {Icon: FaGithub, label:"Github",href:"https://github.com/Vanshikarai29"}
...
//     hover: {
//         scale: 1.2, y: -3,
//         filter: "drop-shadow(0 0 8 px rgba(13,38,204,0.8 ,0.9)) drop-shadow(0 0 18px rgba(16,185,129,0.8))",
//         transition:{type:"spring",stifness:300,damping:10}
//     },
//     tap:{scale:0.95,y:0,transition:{Pduration:0.8}}
// }
...
//                           I turn complex ideas into seamless,high-impact web experiences-building modern,scalable, and lightning-fast apllications that make a difference.
//                       </motion.p>
...
//                               View My Work</a>
//                           <a href="/Resume.pdf"
//                               download className="px-6 py-3 rounded-full text-lg font-medium text-black
...
const socials = [
  { Icon: FaXTwitter, label: "X", href: "https://twitter.com/yourprofile" },
  {
    Icon: FaLinkedin,
    label: "Linkedin",
    href: "https://www.linkedin.com/in/vanshika-rai-2b984a338/",
  },
  { Icon: FaGithub, label: "Github", href: "https://github.com/Vanshikarai29" },
];
...
const glowVariants = {
  ...
  hover: {
    ...
    y: -3,
    filter:
      "drop-shadow(0 0 8px rgba(13,38,204,0.9)) drop-shadow(0 0 18px rgba(16,185,129,0.8))",
          ...
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            <div className="mt-10 flex gap-5 text-2xl md:text-3xl justify-center lg:justify-start">
              ...
              <div className="relative hidden lg:block">
                  ...
                  />
                  <motion.img src={avator} alt="Vanshika Rai"
